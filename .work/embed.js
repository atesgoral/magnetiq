...
var disqus_extra_qs = "";
var disqus_shortname_re = [/https?:\/\/(www\.)?disqus\.com\/forums\/([\w_\-]+)/i, /https?:\/\/(www\.)?([\w_\-]+)\.disqus\.com/i, /https?:\/\/(www\.)?dev\.disqus\.org\/forums\/([\w_\-]+)/i];
var disqus_browser = {
...
if (typeof(disqus_remote_auth_s2) != "undefined") {
    disqus_extra_qs += "&remote_auth_s2=" + encodeURIComponent(disqus_remote_auth_s2)
}
...
disqus_stylesheet.href = "http://" + disqus_domain + "/forums/" + disqus_shortname + "/styles.css";
...
disqus_script.src = "http://" + disqus_shortname + "." + disqus_domain + "/thread.js?url=" + encodeURIComponent(disqus_url) + "&message=" + encodeURIComponent(disqus_message) + "&title=" + encodeURIComponent(disqus_title) + "&sort=" + encodeURIComponent(disqus_sort) + "&category_id=" + encodeURIComponent(disqus_category_id) + "&developer=" + ((disqus_developer == "0" || !disqus_developer) ? 0 : 1) + "&identifier=" + encodeURIComponent(disqus_identifier) + disqus_extra_qs + "&" + disqus_date.getTime();
...
var dsq_reload_loader = function () {
    ...
    a.src = disqus_script.src = "http://" + disqus_shortname + "." + disqus_domain + "/embed.js";
